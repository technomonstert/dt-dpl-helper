...
def process_log_file(
    ...
    if custom_list:
        ...
        for idx, alias in enumerate(alias_list):
            ...
            # ----------------------------------------------------------------------
            # Special‑case handling for known field names
            # ----------------------------------------------------------------------
            if not mtype:  # only decide when the user didn’t force a type
            ...
            if mtype == "TIMESTAMP":
                ...
                # Upper‑case transformation – no matcher class needed
                ...
                # JSONMatcher does not accept a literal argument
